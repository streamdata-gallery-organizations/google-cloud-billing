...
- name: Google Cloud Billing API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-cloud-billing/master/_listings/google-cloud-billing/v1-name-projects-get.md
x-common:
- type: x-code
